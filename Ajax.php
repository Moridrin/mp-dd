...
add_action('wp_ajax_mp_mp_dd_filterContent', [Ajax::class, 'filterContent']);
add_action('wp_ajax_mp_mp_dd_delete_log_entry', [Ajax::class, 'deleteLogEntry']);
add_action('wp_ajax_mp_mp_dd_save_player', [Ajax::class, 'savePlayer']);
add_action('wp_ajax_mp_mp_dd_delete_player', [Ajax::class, 'deletePlayer']);
add_action('wp_ajax_mp_mp_dd_save_monster', [Ajax::class, 'saveMonster']);
add_action('wp_ajax_mp_mp_dd_delete_monster', [Ajax::class, 'deleteMonster']);
