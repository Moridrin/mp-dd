 ...
 */
function str_get_html(string $str, $lowercase = true, $forceTagsClosed = true, $target_charset = DEFAULT_TARGET_CHARSET, $stripRN = true, $defaultBRText = DEFAULT_BR_TEXT, $defaultSpanText = DEFAULT_SPAN_TEXT)
{
    $dom = new simple_html_dom(null, $lowercase, $forceTagsClosed, $target_charset, $stripRN, $defaultBRText, $defaultSpanText);
...
class simple_html_dom_node
{
    ...
    public function parent(simple_html_dom_node $parent = null): simple_html_dom_node
    {
    ...
    public function first_child(): simple_html_dom_node
    {
    ...
    public function last_child(): simple_html_dom_node
    {
    ...
    public function next_sibling(): simple_html_dom_node
    {
        if ($this->parent === null) {
            return null;
        }
    ...
    public function prev_sibling(): simple_html_dom_node
    {
        if ($this->parent === null) {
            return null;
        }
    ...
    public function find_ancestor_tag(string $tag): simple_html_dom_node
    {
        global $debugObject;
...
//        $pattern = "/([\w-:\*]*)(?:\#([\w-]+)|\.([\w-]+))?(?:\[@?(!?[\w-]+)(?:([!*^$]?=)[\"']?(.*?)[\"']?)?\])?([\/, ]+)/is";
    ...
    */
     ...
     */
    public function get_display_size(): array
    {
        global $debugObject;
    ...
    public function parentNode(): simple_html_dom_node
    {
        return $this->parent();
    }
    ...
    public function firstChild(): simple_html_dom_node
    {
        return $this->first_child();
    }

    public function lastChild(): simple_html_dom_node
    {
        return $this->last_child();
    }

    public function nextSibling(): simple_html_dom_node
    {
        return $this->next_sibling();
    }

    public function previousSibling(): simple_html_dom_node
    {
    ...
    public function appendChild(simple_html_dom_node $node): simple_html_dom_node
    {
        $node->parent($this);
        return $node;
    }
...
class simple_html_dom
{
    ...
    public function load($str, $lowercase = true, $stripRN = true, $defaultBRText = DEFAULT_BR_TEXT, $defaultSpanText = DEFAULT_SPAN_TEXT): simple_html_dom
    {
        global $debugObject;
    ...
    public function set_callback(callback $function_name)
    {
    ...
    public function dump(bool $show_attr = true)
    {
        $this->root->dump($show_attr);
    }

    // prepare HTML data and init everything
    protected function prepare(string $str, bool $lowercase = true, bool $stripRN = true, string $defaultBRText = DEFAULT_BR_TEXT, string $defaultSpanText = DEFAULT_SPAN_TEXT)
    {
        $this->clear();
    ...
    // parse attributes
    protected function parse_attr(simple_html_dom_node $node, string $name, array &$space)
    {
    ...
    // link node's parent
    protected function link_nodes(simple_html_dom_node &$node, bool $is_child)
    {
        $node->parent          = $this->parent;
    ...
    protected function remove_noise(string $pattern, bool $remove_tag = false)
    {
        global $debugObject;
        if (is_object($debugObject)) {
            $debugObject->debugLogEntry(1);
    ...
    public function createElement(string $name, string $value = null): simple_html_dom_node
    {
        return @str_get_html("<$name>$value</$name>")->first_child();
    }

    public function createTextNode(string $value): simple_html_dom_node
    {
