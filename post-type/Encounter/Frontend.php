...
namespace mp_dd\PostType\Encounter;
...
use mp_dd\PostType\Encounter\Templates\ActionLog;
use mp_dd\PostType\Encounter\Templates\EncounterForm;
use mp_dd\PostType\Encounter\Templates\EncounterSetup;
use mp_dd\PostType\Encounter\Templates\FinishForm;
use Exception;
...
abstract class Frontend
{
    ...
    private static function getEncounterSetup(int $postId, string $content): string
    {
        ...
        require_once 'templates/'.MP_DD::getCurrentTheme().'/EncounterSetup.php';
    ...
    {
        $currentTheme = MP_DD::getCurrentTheme();
        /** @noinspection PhpIncludeInspection */
